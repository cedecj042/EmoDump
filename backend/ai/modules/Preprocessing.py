...
with open(os.path.join(settings.DATA_DIR, 'data/emoticon_dict.json'), 'r') as file:
...
def expand_abbreviations(text):
    abbreviations_dict = create_dict_from_csv(os.path.join(settings.DATA_DIR, 'data/abbv.csv'))
...
def customize_stopwords(stopwords):
    ...
    interjections = load_stopwords_from_csv(os.path.join(settings.DATA_DIR,'data/interjections.csv'))
    negations = load_stopwords_from_csv(os.path.join(settings.DATA_DIR,'data/negations.csv'))
    amplifiers = load_stopwords_from_csv(os.path.join(settings.DATA_DIR,'data/interjections.csv'))
